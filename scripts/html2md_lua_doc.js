...
//要遍历的文件夹所在的路径
let DIR_EN = path.resolve('../../../lua/lua53doc/')
let DIR_AC = path.resolve('../../../lua/lua53doc_anchor/')
let TEMP = path.resolve('../../../lua/lua53doc_temp/')
let DIR_MD = path.resolve('../../../lua/lua53doc_md/')
    ...
    if (states.isFile() && fileInfo.endsWith('.html')) {
      ...
      reader.on('close', function () {
        writeStream.close(function () {
          ...
          md = md.replaceAll('contents.html', 'contents.md')
          md = md.replaceAll('glossary.html', 'glossary.md')
          md = md.replaceAll('index.html', 'index.md')
          md = md.replaceAll('manual.html', 'manual.md')
          md = md.replaceAll('logo.gif', 'http://cloudwu.github.io/lua53doc/logo.gif')
          md = md.replaceAll('osi-certified-72x60.png', 'http://cloudwu.github.io/lua53doc/osi-certified-72x60.png')
